...
namespace InfiniteTerrain {
    ...
    public class Pool {
        ...
        public Pool (GameObject original, int initialSize) {
            m_Original = original;
        ...
        public GameObject Get (Vector3 pos, Vector3 rot, Transform parent = null) {
            return Get (pos, Quaternion.Euler (rot.x, rot.y, rot.z), parent);
        }

        public GameObject Get (Vector3 pos, Quaternion quat, Transform parent = null) {
